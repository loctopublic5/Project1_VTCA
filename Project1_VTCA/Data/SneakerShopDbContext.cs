...
namespace Project1_VTCA.Data
{
    public class SneakerShopDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 1, Name = "Nike Air Force 1 '07", Description = "Biểu tượng bất hủ của Nike, thiết kế da trơn cổ điển, đệm Air-Sole êm ái. Phù hợp mọi phong cách, dễ phối đồ, độ bền cao.", Price = 2290000.00m, GenderApplicability = "Unisex", IsActive = true });
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 2, Name = "Adidas Superstar", Description = "Thiết kế mũi vỏ sò (shell-toe) đặc trưng và 3 sọc răng cưa kinh điển. Một trong những đôi sneaker có ảnh hưởng nhất mọi thời đại, dễ nhận diện.", Price = 1890000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 3, Name = "Converse Chuck Taylor All Star Classic", Description = "Phiên bản cổ cao kinh điển với thân giày bằng vải canvas bền chắc, đế cao su lưu hóa. Biểu tượng của sự trẻ trung, cá tính và tự do.", Price = 1395000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 5, Name = "New Balance 574 Core", Description = "Dáng giày chạy bộ cổ điển từ những năm 80. Công nghệ ENCAP ở đế giữa giúp tăng cường độ ổn định. Thân giày kết hợp da lộn và vải lưới thoáng khí. Mang đậm phong cách vintage.", Price = 779000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 6, Name = "Nike Air Max 90", Description = "Thiết kế mang tính cách mạng với cửa sổ Air có thể nhìn thấy ở gót chân. Kiểu dáng mạnh mẽ, năng động. Một trong những dòng Air Max được yêu thích nhất.", Price = 2800000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 8, Name = "Fila Disruptor 2", Description = "Mẫu giày chunky \"đình đám\" với đế ngoài răng cưa hầm hố. Thiết kế logo Fila nổi bật. Tạo nên phong cách thời trang cá tính và thu hút.", Price = 1500000.00m, GenderApplicability = "Female", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 9, Name = "Biti's Hunter X", Description = "Dòng sneaker thành công của Biti's, thiết kế trẻ trung. Công nghệ đế LiteFlex siêu nhẹ và êm. Nhiều phiên bản màu sắc và collab độc đáo.", Price = 767000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 10, Name = "Ananas Basas Bumper Gum", Description = "Thiết kế vulcanized cổ điển, tối giản. Thân giày canvas, đế gum đặc trưng. Được giới trẻ yêu thích vì sự đơn giản và chất lượng.", Price = 580000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 11, Name = "Nike Cortez", Description = "Mẫu giày chạy bộ biểu tượng từ những năm 70. Thiết kế đơn giản, thanh lịch với dấu Swoosh lớn. Đế giữa EVA nhẹ, đế ngoài xương cá tăng độ bám.", Price = 1800000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 15, Name = "New Balance 550", Description = "Mẫu giày bóng rổ cổ điển từ cuối những năm 80, được tái sinh và trở thành hiện tượng. Thiết kế da trơn, form dáng gọn gàng. Mang phong cách retro thể thao.", Price = 1095000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 16, Name = "Puma Suede Classic", Description = "Mẫu giày da lộn kinh điển của Puma từ năm 1968. Thiết kế đơn giản với formstripe đặc trưng. Gắn liền với văn hóa hip-hop và b-boy.", Price = 1500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 17, Name = "Nike Blazer Low '77", Description = "Thiết kế bóng rổ cổ điển với kiểu dáng low-top. Thân giày da, dấu Swoosh lớn. Mang vẻ đẹp vintage, dễ phối đồ.", Price = 3239000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 18, Name = "Adidas Forum Low", Description = "Mẫu giày bóng rổ từ những năm 80, với chi tiết quai dán đặc trưng ở cổ chân (phiên bản Mid/High) hoặc thiết kế cổ thấp gọn gàng.", Price = 2590000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 19, Name = "New Balance 327", Description = "Lấy cảm hứng từ các mẫu giày chạy bộ thập niên 70 của New Balance. Thiết kế độc đáo với logo \"N\" lớn và đế ngoài răng cưa kéo dài.", Price = 2200000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 21, Name = "MLB BigBall Chunky", Description = "Giày chunky đến từ thương hiệu thời trang Hàn Quốc, nổi bật với logo của các đội bóng chày MLB. Đế giày cao và hầm hố.", Price = 1800000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 22, Name = "Ananas Urbas Corluray Pack", Description = "Thuộc dòng Urbas, sử dụng chất liệu nhung gân (corduroy) độc đáo với 5 gam màu lấy cảm hứng từ mùa thu. Thiết kế vulcanized, phong cách vintage, phi giới tính.", Price = 580000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 24, Name = "Adidas NMD_R1", Description = "Kết hợp giữa thiết kế hiện đại và công nghệ Boost êm ái. Các miếng nhựa EVA đặc trưng ở đế giữa. Thân giày Primeknit hoặc vải lưới. Nhẹ nhàng và thoải mái.", Price = 2090000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 25, Name = "Vans Authentic", Description = "Mẫu giày đầu tiên của Vans, thiết kế đơn giản, cổ thấp, dây buộc. Thân giày canvas, đế bánh quế. Một lựa chọn cơ bản và linh hoạt.", Price = 1087500.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 26, Name = "New Balance 9060", Description = "Thiết kế chunky lấy cảm hứng từ dòng 99X và các mẫu giày chạy bộ đầu những năm 2000. Đế giữa ABZORB và SBS êm ái. Kiểu dáng độc đáo, phá cách.", Price = 1479000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 27, Name = "Puma RS-X Series", Description = "Dòng giày chunky lấy cảm hứng từ công nghệ Running System (RS) thập niên 80. Thiết kế nhiều lớp, màu sắc nổi bật, đế giày dày và êm.", Price = 1590000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 28, Name = "Biti's Hunter Street", Description = "Dòng giày đường phố của Biti's Hunter, thiết kế trẻ trung, năng động, dễ phối đồ. Tập trung vào sự thoải mái và tính ứng dụng hàng ngày.", Price = 679000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 29, Name = "Ananas Vintas Public 2000s", Description = "Thuộc dòng Vintas, mang phong cách retro của những năm 2000. Thiết kế đơn giản, sử dụng chất liệu canvas và da lộn.", Price = 620000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 30, Name = "Nike Dunk Low", Description = "Xuất thân là giày bóng rổ, trở thành biểu tượng thời trang đường phố. Thiết kế cổ thấp, nhiều phối màu đa dạng và các phiên bản collab.", Price = 2750000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 31, Name = "Adidas Gazelle", Description = "Mẫu giày training cổ điển từ những năm 60. Thân giày da lộn mềm mại, đế cao su. Thiết kế thanh lịch, gọn gàng.", Price = 2000000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 32, Name = "Converse Run Star Hike", Description = "Biến thể hiện đại của Chuck Taylor với đế chunky răng cưa độc đáo. Thân giày canvas quen thuộc. Tạo điểm nhấn cá tính cho phong cách.", Price = 2500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 33, Name = "Vans Sk8-Hi", Description = "Phiên bản cổ cao của Old Skool, tăng cường bảo vệ mắt cá chân. Sọc jazz đặc trưng, chất liệu canvas và da lộn. Gắn liền với văn hóa trượt ván.", Price = 1755000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 34, Name = "New Balance 2002R", Description = "Lấy cảm hứng từ giày chạy bộ cao cấp những năm 2000. Đế giữa ABZORB và N-ergy êm ái. Thiết kế kỹ thuật, chất liệu cao cấp.", Price = 3000000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 35, Name = "Puma Cali", Description = "Lấy cảm hứng từ mẫu giày California cổ điển. Thiết kế đế platform nhẹ nhàng, nữ tính. Thân giày da. Phong cách thoải mái, phóng khoáng.", Price = 1800000.00m, GenderApplicability = "Female", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 36, Name = "Nike Air Jordan 1 Low", Description = "Phiên bản cổ thấp của huyền thoại Air Jordan 1. Thiết kế mang tính biểu tượng, nhiều phối màu lịch sử và mới mẻ. Chất liệu da.", Price = 3190000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 37, Name = "Adidas Alphabounce", Description = "Thiết kế hiện đại, tập trung vào sự thoải mái và đa năng. Đệm Bounce linh hoạt. Thân giày Forgedmesh hoặc Engineered Mesh.", Price = 2000000.00m, GenderApplicability = "Male", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 38, Name = "Asics GEL-Lyte III", Description = "Mẫu giày chạy bộ cổ điển từ những năm 90, nổi tiếng với thiết kế lưỡi gà chẻ đôi (split tongue). Công nghệ đệm GEL êm ái.", Price = 2500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 39, Name = "Fila Ray Tracer", Description = "Mẫu giày chunky lấy cảm hứng từ thập niên 90. Thiết kế nhiều lớp chất liệu, đế giày hầm hố. Phối màu đa dạng, trẻ trung.", Price = 1500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 40, Name = "Biti's Hunter Jogging/Running", Description = "Các dòng giày chạy bộ của Biti's Hunter, tập trung vào hiệu năng và sự thoải mái. Công nghệ đế Phylon hoặc LiteFlex.", Price = 881000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 41, Name = "Ananas Pattas \"Simple Story\"", Description = "Dòng giày Pattas với thiết kế tối giản, tập trung vào câu chuyện và thông điệp. Thân giày canvas, đế vulcanized.", Price = 500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 42, Name = "Nike Air Max Dn", Description = "Dòng Air Max mới nhất với công nghệ Dynamic Air (các ống Air có áp suất kép). Mang lại cảm giác chuyển động mượt mà và năng động.", Price = 3500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 43, Name = "Adidas Samba OG", Description = "Mẫu giày sân cỏ trong nhà (indoor football) kinh điển. Thân giày da hoặc da lộn, đế gum. Thiết kế vượt thời gian, đang rất thịnh hành trở lại.", Price = 2290000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 44, Name = "Converse Chuck Taylor All Star Move", Description = "Phiên bản hiện đại của Chuck Taylor với đế platform nhẹ và cao. Mang lại vẻ ngoài năng động và tôn dáng.", Price = 1800000.00m, GenderApplicability = "Female", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 45, Name = "Vans Knu Skool", Description = "Lấy cảm hứng từ giày trượt ván thập niên 90, với thiết kế \"phồng\" hơn, lưỡi gà dày và sọc jazz 3D nổi. Mang phong cách chunky retro.", Price = 1000000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 46, Name = "New Balance 530", Description = "Mẫu giày chạy bộ cổ điển từ những năm 90, nay trở thành item thời trang được yêu thích. Đế giữa ABZORB êm ái. Thân giày lưới và da tổng hợp.", Price = 2490000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 47, Name = "Puma Mayze Lth", Description = "Thiết kế đế platform cá tính, lấy cảm hứng từ sự nhộn nhịp đô thị. Dành cho những cô gái yêu thích phong cách thời trang đường phố. Thân giày da.", Price = 2000000.00m, GenderApplicability = "Female", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 48, Name = "Nike Zoom Vomero 5", Description = "Mẫu giày chạy bộ đầu những năm 2000, nay trở lại với phong cách retro-tech. Đệm Zoom Air và Cushlon êm ái. Thiết kế nhiều lớp, chi tiết.", Price = 3500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 49, Name = "Adidas Campus 00s", Description = "Lấy cảm hứng từ Adidas Campus cổ điển nhưng với tỷ lệ phóng đại, mang hơi hướng giày skate thập niên 2000. Thân giày da lộn, dây giày bản to.", Price = 2500000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
            ...
            modelBuilder.Entity<Product>().HasData(new Product { ProductID = 50, Name = "Biti's Hunter Core LiteFoam 3.0", Description = "Phiên bản nâng cấp của dòng Core với công nghệ đế LiteFoam 3.0 cải tiến, tăng độ êm và nhẹ. Thiết kế đa năng, phù hợp nhiều hoạt động.", Price = 843000.00m, GenderApplicability = "Unisex", IsActive = true });
            modelBuilder.Entity<ProductCategory>().HasData(
