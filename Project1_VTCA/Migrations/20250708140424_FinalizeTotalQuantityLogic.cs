...
{
    /// <inheritdoc />
    public partial class FinalizeTotalQuantityLogic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            -- Xóa trigger cũ nếu nó tồn tại để tránh lỗi
            DROP TRIGGER IF EXISTS TRG_ProductSizes_UpdateTotalQuantity;
            GO

            -- Tạo trigger mới với logic đã sửa, không có PRIMARY KEY trên bảng tạm
            ...
            BEGIN
                ...
                -- Thu thập tất cả các ProductID bị ảnh hưởng (cho phép trùng lặp)
            ...
            // Do GO không được hỗ trợ trong ExecuteSqlRaw, chúng ta tách làm hai lệnh
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS TRG_ProductSizes_UpdateTotalQuantity;");
            

            // Bước 2: Đồng bộ hóa toàn bộ dữ liệu cũ
